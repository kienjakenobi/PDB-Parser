...
distM :: Protein -> Int -> Int -> [(Int, Double)]
distM p k ind
...
lindistM :: Protein -> Int -> Int -> [(Int, Double)]
lindistM p k ind
    | ind + (k - 1) == ed = []
...
lindist :: Protein -> Int -> [(Int, Double)]
...
alldist :: Protein -> Int -> Atom -> [Double]
alldist [] _ _ = []
alldist p k a
